...
public class RolandMDX_20ControlPanel extends PApplet {
...
public void sendRMLFile(String path) {
 ...
 roland_port.write(sendFirstLineWithSpeeds);
    ...
    for (int i = 1; i < lines.length-1; i++) {
     // roland_port.write(lines[i+1]);
      ...
      if (speed <= 10) {
        //speed = int(getVS);
        delay(PApplet.parseInt(distance* 40/ (speed / 10) ));//2500
      } else {
 ...
 // roland_port.write("PA;PA;!PZ0,0;!MC0;");
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "RolandMDX_20ControlPanel" };
    if (passedArgs != null) {
